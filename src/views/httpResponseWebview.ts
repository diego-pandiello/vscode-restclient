...
export class HttpResponseWebview extends BaseWebview {
    ...
    public constructor(context: ExtensionContext) {
        ...
        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.fold-response', this.foldResponseBody, this));
        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.unfold-response', this.unfoldResponseBody, this));
        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.preview-html-response-body', this.previewResponseBody, this));
        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.show-raw-response', this.showRawResponse, this));

        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.copy-response-body', this.copyBody, this));
        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.save-response', this.save, this));
        this.context.subscriptions.push(commands.registerCommand('aws-srp-rest-client.save-response-body', this.saveBody, this));
    }
